...
const Experience: React.FC<ExperienceProps> = (props: ExperienceProps) => {
  return (
    <div
      className={` before:-translate-x-[1.7rem] ${props.showBorder && "border-l-2 border-solid border-l-primary-300 before:-translate-x-[1.82rem]"
        } max-h-max p-5 pt-0 before:absolute before:inline-block before:h-4 before:w-4 before:content-normal before:rounded-full before:bg-primary before:shadow-primary before:drop-shadow-xl`}
    >
      <div
